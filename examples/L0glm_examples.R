...
L0glm7 <- L0glm(X = X, y = y, family = poisson(identity), intercept = FALSE,
                lambda = 10^seq(-3,3, length.out = 51), # Use arbitrary sequence
...
L0glm8 <- L0glm(X = X, y = y, family = poisson(identity), intercept = FALSE,
                lambda = 10^seq(-3,3, length.out = 51), # Use arbitrary sequence
